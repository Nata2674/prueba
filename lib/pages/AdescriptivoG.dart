...
class AdescriptivoG extends StatefulWidget {
  @override
  State<AdescriptivoG> createState() => _AdescriptivoPAState();
}

class _AdescriptivoPAState extends State<AdescriptivoG> {
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text(dateFormat.format(
                        selectedDate1)), // Muestra la fecha seleccionada
                    ...
                    Text(dateFormat.format(
                        selectedDate2)), // Muestra la segunda fecha seleccionada
                    // Se le agrega mas espacio entre elementos
                    SizedBox(width: 70),
                    // Boton "Mostrar"
                    ElevatedButton(
                      onPressed: () {
                        String Fecha1 = DateFormat("yyyy-MM-dd").format(selectedDate1);
                        String Fecha2 = DateFormat("yyyy-MM-dd").format(selectedDate2);
                        print(Fecha1);
                        print(Fecha2);
...
/*width: double.infinity,
            ...
            child: Row(
              ...
              children: [
                ...
                Text(dateFormat
                    .format(selectedDate1)), // Muestra la fecha seleccionada
...
//Esta clase es para el texto que la IA mandara en el futuro
/*class TextContainer extends StatelessWidget {
  final String texto;

  TextContainer({required this.texto});
